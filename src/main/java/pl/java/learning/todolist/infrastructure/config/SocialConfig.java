...
import pl.java.learning.todolist.infrastructure.security.SecurityImplicitConnectionSignUp;
...
public class SocialConfig implements SocialConfigurer {
  ...
  public UsersConnectionRepository getUsersConnectionRepository(
    ...
    repository.setConnectionSignUp(
        new SecurityImplicitConnectionSignUp(userRepository, roleRepository, passwordEncoder));
    return repository;
  }
}
